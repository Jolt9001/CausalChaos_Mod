...
public class CCAdvancementGenerator implements ForgeAdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> consumer, ExistingFileHelper fileHelper) {
        ...
        var mastery3 = builder; // "Hero" Prereq: mastery2
        var mastery4 = builder; // "Superhero" Prereq: mastery3
        var mastery5 = builder; // "Limitless" Prereq: mastery4
        ...
        var loopEscape = builder; // "Shattered Dimension" Prereq: fightDL1
        var quantumSigil = builder; // "Monstrous Resurrection" Prereq: fightDL1, riftwalkerKill
        ...
        var obtainStarforge = builder
                ...
                .save(consumer, "causalchaos.main/get_starforge");
        var obtainThundersteel = builder
                ...
                .save(consumer, "causalchaos.main/get_thundersteel");
        var obtainPerplexium = builder
                ...
                .save(consumer, "causalchaos.main/get_perplexium");
