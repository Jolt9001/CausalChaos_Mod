...
public class TitaniumArmorItem extends ArmorItem {
    public TitaniumArmorItem(ArmorMaterial material, Type type, Properties properties) {
    ...
    public String getArmorTexture(ItemStack s, Entity e, EquipmentSlot slot, String layer) {
        if (slot == EquipmentSlot.LEGS) {
            return CausalChaos.ARMOR_DIR + "titanium_layer_2.png";
        } else {
            return CausalChaos.ARMOR_DIR + "titanium_layer_1.png";
        }
    }
}
