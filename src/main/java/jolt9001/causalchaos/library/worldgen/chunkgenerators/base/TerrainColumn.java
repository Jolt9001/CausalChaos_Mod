...
public final class TerrainColumn {
    /*
    public static final Codec<TerrainColumn> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
    ...
    public TerrainColumn(Holder<Biome> keyBiome, Double2ObjectSortedMap<Holder<Biome>> biomes, DensityFunction noiseDepth, DensityFunction noiseScale) {
        ...
        if (this.biomes instanceof Double2ObjectAVLTreeMap<Holder<Biome>> treeMap) treeMap.defaultReturnValue(this.keyBiome);
    }
