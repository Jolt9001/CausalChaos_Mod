...
public class CCTiers {
    ...
    public static final Tier THUNDERSTEEL = TierSortingRegistry.registerTier(
            ...
            CausalChaos.prefix("thundersteel"), List.of(Tiers.NETHERITE/*CCTiers.TUNGSTEN*/), List.of(/*CCTiers.INFUSED_THUNDERSTEEL*/));
    ...
    public static final Tier INFUSED_THUNDERSTEEL = TierSortingRegistry.registerTier(
            ...
            CausalChaos.prefix("infused_thundersteel"), List.of(Tiers.NETHERITE/*CCTiers.THUNDERSTEEL*/), List.of(/*CCTiers.PERPLEXIUM*/));
    ...
    public static final Tier PERPLEXIUM = TierSortingRegistry.registerTier(
            ...
            CausalChaos.prefix("perplexium"), List.of(Tiers.NETHERITE/*CCTiers.INFUSED_THUNDERSTEEL*/), List.of(/*CCTiers.SUPERWEAPON*/));
